...
# Currently in the migrate section the code exists there but copied and commented out below for reference 
...
for movie in all_movies
    puts "#{movie["title"]} | #{movie["year_released"]} | #{movie["rated"]} #{studio_id["name"]}"
end 
